...
export const argDefinitions: Array<CommandLineDefinition> = [
    {
        ...
        description: 'Path to a .app, .dSYM, .bundle, .xcarchive, .framework, .dylib, or macOS binary file.',
    },
    {
        name: 'help',
        alias: 'h',
...
export const usageDefinitions: Array<Section> = [
    {
        header: 'macho-uuid',
        content: 'A command line utility and library for reading the UUID of a .app, .dSYM, .bundle, .xcarchive, .framework, .dylib, or macOS binary file.',
    },
    {
        header: 'Usage',
