...
describe('MachoFile', () => {
    describe('getHeader', () => {
        it('should throw if signature isn\'t valid', async () => {
            const macho = new MachoFile('spec/support/corrupt.app');
        ...
        it('should return Mach-O header', async () => {
            const macho = new MachoFile('spec/support/bugsplat.app.dSYM');
    ...
    describe('getUUID', () => {
        ...
        it('should return UUID for dsym', async () => {
            const file = new MachoFile('spec/support/bugsplat.app.dSYM');
        ...
        it('should return UUID for app', async () => {
            const file = new MachoFile('spec/support/bugsplat-ios.app');
            const uuid = await file.getUUID();
